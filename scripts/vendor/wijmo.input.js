            ...
            Object.defineProperty(ListBox.prototype, "checkedItems", {
                ...
                */
                ...
                set: function (value) {
                    ...
                    if (this._cv) {
                        for (var i = 0; i < this._cv.items.length; i++) {
                            this._setItemChecked(i, arr.indexOf(i) > -1, false);
                        }
        ...
        var InputNumber = (function (_super) {
            ...
            */
            ...
            InputNumber.prototype._setText = function (text) {
                ...
                if (text == '-' || text == ')') {
                    this._tbx.value = text;
                    wijmo.setSelectionRange(this._tbx, 1, 1);
                    return;
                }
                ...
                if (e.charCode) {
                    ...
                    if (chr == this._decChar) {
                        ...
                        if (pos > -1) {
                            ...
                            wijmo.setSelectionRange(this._tbx, pos, pos);
                            e.preventDefault();
                        }
                    }
                }
                    ...
                    case 8 /* Back */:
                        if (this._getSelStart() == this._tbx.selectionEnd) {
                            ...
                            if (sel > 0 && this.text[sel - 1] == this._decChar) {
                                wijmo.setSelectionRange(this._tbx, sel - 1, sel - 1);
                                e.preventDefault();
                            }
                        }
                        break;
            ...
            InputNumber.prototype._input = function (e) {
                ...
                if (text) {
                    ...
                    // set cursor position
                    wijmo.setSelectionRange(tbx, sel, sel);
                }
            };
