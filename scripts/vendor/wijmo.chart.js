            ...
            */
            ...
            FlexPie.prototype._render = function (engine) {
                ...
                if (w > 0 && h > 0) {
                    ...
                    var hasOutLabels = lbl.content && lbl.position == 3 /* Outside */;
                    ...
                    if (this.dataLabel.content && this.dataLabel.position != 0 /* None */) {
                ...
                if (sum > 0) {
                    ...
                    for (var i = 0; i < len; i++) {
                        ...
                        if (this.itemFormatter) {
                            var hti = new chart.HitTestInfo(this, new wijmo.Point(cx + r * Math.cos(currentAngle), cy + r * Math.sin(currentAngle)), 8 /* SeriesSymbol */);
                            hti._setData(null, i);
            ...
            FlexPie.prototype._renderLabels = function (engine) {
                var len = this._areas.length, lbl = this.dataLabel, pos = lbl.position, marg = 2, lcss = 'wj-data-label', bcss = 'wj-data-label-border', clcss = 'wj-data-label-line', da = this._rotationAngle, line = lbl.connectingLine, lofs = lbl.offset ? lbl.offset : 0;
                engine.stroke = 'null';
                engine.fill = 'transparent';
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    if (seg) {
                        ...
                        var pt = new wijmo.Point(this._center.x + dx + r0 * Math.cos(a), this._center.y + dy + r0 * Math.sin(a));
                        ...
                        if (content) {
                            ...
                            if (line) {
                                var pt2 = new wijmo.Point(this._center.x + dx + (r) * Math.cos(a), this._center.y + dy + (r) * Math.sin(a));
            ...
            FlexPie.prototype._select = function (pointIndex, animate) {
                ...
                if (!this.isAnimated && (this.selectedItemOffset > 0 || this.selectedItemPosition != 0 /* None */)) {
                    this.invalidate();
                }
            };
            ...
            FlexPie.prototype._animateSelectionAngle = function (target, duration) {
                ...
                this._selectionAnimationID = wijmo.animate(function (pct) {
                    if (group == self._pieGroup) {
                        ...
                        if (pct > 0.99) {
                            if (self.selectedItemOffset > 0 || self.selectedItemPosition != 0 /* None */) {
                                self.invalidate();
                            }
                        }
                    }
            ...
            */
                    ...
                    if (smap) {
                        ...
                        for (var j = 0; j < len; j++) {
                            ...
                            if (dp) {
                                ...
                                var ax = ser._getAxisX(), ay = ser._getAxisY();

                                var pt = new wijmo.Point(ax.convert(dp.dataX), ay.convert(dp.dataY));
                                var map = smap[j];
                                ...
                                var ea = new chart.DataLabelRenderEventArgs(engine, ht, pt, s);
                                ...
                                if (!lbl.onRendering(ea)) {
                                    ...
                                    if (lrct) {
                                        var area = new chart._RectArea(lrct);
                                        area.tag = dp;
            ...
            FlexChartCore.prototype._layoutSingle = function (rect, size, engine) {
                ...
                for (var i = 0; i < axes.length; i++) {
                    ...
                    if (ax.axisType == 0 /* X */) {
                        ...
                        var hasOrigin = ax._hasOrigin = wijmo.isNumber(origin) && origin > this.axisY._getMinNum() && origin < this.axisY._getMaxNum();
                        ...
                        var hasOrigin = ax._hasOrigin = wijmo.isNumber(origin) && origin > this.axisX._getMinNum() && origin < this.axisX._getMaxNum();
            ...
            FlexChartCore.prototype._layoutMultiple = function (rect, size, engine) {
                ...
                for (var irow = 0; irow < nrows; irow++) {
                    ...
                    for (var i = 0; i < ad.axes.length; i++) {
                        var ax = ad.axes[i];
                        var szy = new wijmo.Size(mysz.width, ax._getHeight(engine));
        ...
        var FlexChart = (function (_super) {
            ...
            */
            ...
            Object.defineProperty(FlexChart.prototype, "stacking", {
                /**
                * Gets or sets whether and how the series objects are stacked.
                */
                get: function () {
...
(function (wijmo) {
    (function (_chart) {
        ...
        */
        ...
        })(_chart.Position || (_chart.Position = {}));
        var Position = _chart.Position;
        ;
        ...
        */
        ...
        })(_chart.AxisType || (_chart.AxisType = {}));
        var AxisType = _chart.AxisType;
        ...
        */
        ...
        })(_chart.OverlappingLabels || (_chart.OverlappingLabels = {}));
        var OverlappingLabels = _chart.OverlappingLabels;
        ...
        */
        ...
        })(_chart.TickMark || (_chart.TickMark = {}));
        var TickMark = _chart.TickMark;
        ...
        var Axis = (function () {
            ...
            */
                ...
                */
                ...
                set: function (value) {
                    if (value != this._position) {
                        ...
                        if (this._position == 4 /* Bottom */ || this._position == 2 /* Top */) {
                            this._axisType = 0 /* X */;
                        } else {
                            this._axisType = 1 /* Y */;
                        }
            ...
            Object.defineProperty(Axis.prototype, "labelAlign", {
                ...
                *
                * By default the labels are centred. The supported values are 'left' and 'right
                ...
                */
                ...
                set: function (value) {
                    if (value != this._parea) {
                        this._parea = wijmo.asType(value, _chart.PlotArea, true);
                        this._invalidate();
                    }
                },
                enumerable: true,
            ...
            */
            Axis.prototype._getHeight = function (engine) {
                var lblClass = _chart.FlexChart._CSS_LABEL;
                var titleClass = _chart.FlexChart._CSS_TITLE;
            ...
            Axis.prototype._updateAutoFormat = function (delta) {
                if (this._isTimeAxis) {
                    ...
                    var tdelta = isNaN(this._majorUnit) ? _timeHelper.NiceTimeSpan(trange, fmt) : _timeSpan.fromDays(this._majorUnit);
                    if (!fmt)
            ...
            */
            Axis.prototype._render = function (engine) {
                ...
                var lblClass = _chart.FlexChart._CSS_LABEL;
                var titleClass = _chart.FlexChart._CSS_TITLE;
                var lineClass = _chart.FlexChart._CSS_LINE;
                var glineClass = _chart.FlexChart._CSS_GRIDLINE;
                var tickClass = _chart.FlexChart._CSS_TICK;
                var labelAngle = 0;
                if (this.labelAngle) {
                            ...
                            if (isVert) {
                                ...
                                if (isNear) {
                                    ...
                                    if (showLabel) {
                                        ...
                                        if (labelAngle > 0) {
                                            if (labelAngle == 90) {
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 1, 0, lpt, labelAngle, lblClass);
                                            } else {
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 2, 1, lpt, labelAngle, lblClass);
                                            }
                                        } else if (labelAngle < 0) {
                                            if (labelAngle == -90) {
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 1, 2, lpt, labelAngle, lblClass);
                                            } else {
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 2, 1, lpt, labelAngle, lblClass);
                                            }
                                        } else {
                                    ...
                                    if (showLabel) {
                                        ...
                                        if (labelAngle > 0) {
                                            if (labelAngle == 90) {
                                                ...
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 0, 1, lpt, labelAngle, lblClass);
                                            }
                                        } else if (labelAngle < 0) {
                                            if (labelAngle == -90) {
                                                _chart.FlexChart._renderRotatedText(engine, sval, lpt, 1, 0, lpt, labelAngle, lblClass);
                                ...
                                if (this.overlappingLabels == 0 /* Auto */ && this._xCross(x))
                                    showLabel = false;
                                ...
                                if (isNear) {
                                    ...
                                    if (showLabel) {
                                        ...
                                        if (labelAngle != 0) {
                                            ...
                                            this._renderLabel(engine, val, sval, lpt, lalign, 2, lblClass);
                                        }
                                    }
                ...
                if ((this.minorGrid || this.minorTickMarks != 0 /* None */)) {
                    if (!this.logBase)
                ...
                if (isVert) {
                    if (isNear) {
                        if (this._title) {
                            ...
                            _chart.FlexChart._renderRotatedText(engine, this._title, center, 1, 1, center, -90, titleClass);
                        }
                    ...
                    if (isNear) {
                        ...
                        if (this._title) {
                            _chart.FlexChart._renderText(engine, this._title, new wijmo.Point(this._axrect.left + 0.5 * this._axrect.width, this._axrect.bottom), 1, 2, titleClass);
                        }
                    } else {
                        if (this.axisLine) {
                        ...
                        if (this._title) {
                            _chart.FlexChart._renderText(engine, this._title, new wijmo.Point(this._axrect.left + 0.5 * this._axrect.width, this._axrect.top), 1, 0, titleClass);
                        }
                    }
                }
            ...
            Axis.prototype._createMinors = function (engine, vals, isVert, isNear) {
                if (vals && vals.length > 1) {
                    ...
                    var minorUnit = wijmo.isNumber(this.minorUnit) ? (this._isTimeAxis ? this.minorUnit * 24 * 3600 * 1000 : this.minorUnit) : delta * 0.5;
            ...
            Axis.prototype._renderMinors = function (engine, ticks, isVert, isNear) {
                ...
                var tth = this._TICK_WIDTH;
                var tover = this._TICK_OVERLAP;
                var tstroke = _chart.FlexChart._FG;
                ...
                var gth = this._GRIDLINE_WIDTH;
                var gstroke = _chart.FlexChart._FG;

                // css
                var glineClass = _chart.FlexChart._CSS_GRIDLINE_MINOR;
                var tickClass = _chart.FlexChart._CSS_TICK_MINOR;
            ...
            Axis.prototype._renderLabel = function (engine, val, text, pos, ha, va, className) {
                ...
                if (this.itemFormatter) {
                    var pt = pos.clone();
                    if (this.axisType == 0 /* X */) {
                        if (this.position == 2 /* Top */)
                            pt.y = this._plotrect.top;
                        else
                            pt.y = this._plotrect.bottom;
                    } else {
                        if (this.position == 3 /* Right */)
                ...
                if (text) {
                    ...
                    var rect = _chart.FlexChart._renderText(engine, text, pos, ha, va, className, null, null, function (rect) {
                        if (hide) {
                            var len = rects.length;
                            for (var i = 0; i < len; i++) {
                                if (_chart.FlexChart._intersects(rects[i], rect))
                                    return false;
                            }
                        }
                        return true;
            ...
            */
            Axis.prototype.convert = function (val) {
                ...
                if (this._customConvert != null) {
                    var r = this._customConvert(val, this._actualMin, this._actualMax);
            ...
            */
            ...
            Axis.prototype._createLogarithmicLabels = function (min, max, unit, vals, lbls, isLabels) {
                ...
                if (isLabels) {
                    var na = this._getAnnoNumber(this.position == 1 /* Left */ || this.position == 1 /* Left */);
                    if (n > na)
        ...
        */
        ...
        _chart.AxisCollection = AxisCollection;
        ...
        var _timeHelper = (function () {
            function _timeHelper(date) {
                if (wijmo.isDate(date))
                    ...
                    this.init(_chart.FlexChart._fromOADate(date));
            }
        ...
        */
        ...
        var _GridLength = (function () {
            function _GridLength(s) {
                ...
                this._unitType = 0 /* Auto */;
                if (s) {
                    s = s.toString();

                    if (s.indexOf('*') >= 0) {
                        this._unitType = 2 /* Star */;
                        s = s.replace('*', '');
        ...
        */
        var Legend = (function () {
            ...
            Legend.prototype._getPosition = function (w, h) {
                if (this.position == 5 /* Auto */) {
                    return (w >= h) ? 3 /* Right */ : 4 /* Bottom */;
                } else {
            ...
            Legend.prototype._hitTest = function (pt) {
                ...
                for (var i = 0; i < areas.length; i++) {
                    if (areas[i] && _chart.FlexChartCore._contains(areas[i], pt))
                        return i;
                }
        ...
        var HitTestInfo = (function () {
            ...
            */
            ...
            HitTestInfo.prototype._setDataPoint = function (dataPoint) {
                dataPoint = wijmo.asType(dataPoint, _chart._DataPoint, true);
                if (dataPoint) {
        ...
        */
        var _BarPlotter = (function (_super) {
            ...
            _BarPlotter.prototype.adjustLimits = function (dataInfo, plotRect) {
                ...
                if (this.isVolume && (this.chart._getChartType() === 0 /* Column */ || this.chart._getChartType() === 7 /* Candlestick */)) {
                    this.load();
                } else {
                    this.unload();
                }
            ...
            _BarPlotter.prototype.plotSeries = function (engine, ax, ay, series, palette, iser, nser) {
                ...
                var stacked = this.stacking != 0 /* None */;
                var stacked100 = this.stacking == 2 /* Stacked100pc */;
            ...
            _BarPlotter.prototype.drawSymbol = function (engine, rect, series, pointIndex, point) {
                ...
                if (this.chart.itemFormatter) {
                    engine.startGroup();
                    var hti = new chart.HitTestInfo(this.chart, point, 8 /* SeriesSymbol */);
        ...
        */
        var _LinePlotter = (function (_super) {
            ...
            _LinePlotter.prototype._drawSymbol = function (engine, x, y, sz, series, pointIndex) {
                ...
                if (this.chart.itemFormatter) {
                    engine.startGroup();
                    var hti = new chart.HitTestInfo(this.chart, new wijmo.Point(x, y), 8 /* SeriesSymbol */);
                    hti._setData(series, pointIndex);
                ...
                if (this.chart.itemFormatter != null) {
                    ...
                    for (var i = 0; i < areas.length; i++) {
                        ...
                        if (area) {
                            var dpt = area.tag;
                            engine.startGroup();
                            var hti = new chart.HitTestInfo(this.chart, area.center, 8 /* SeriesSymbol */);
    ...
    (function (chart) {
        ...
        var _FinancePlotter = (function (_super) {
            ...
            _FinancePlotter.prototype.adjustLimits = function (dataInfo, plotRect) {
                ...
                if (dt === 4 /* Date */ && this.isVolume && (this.chart._getChartType() === 0 /* Column */ || this.chart._getChartType() === 7 /* Candlestick */)) {
                    return new wijmo.Rect(xmin - 0.5 * dx, ymin, xmax - xmin + dx, ymax - ymin);
                } else {
                ...
                if (this.isCandle) {
                    ...
                    if (chart._DataInfo.isValid(hi) && chart._DataInfo.isValid(lo)) {
                        ...
                        if (rotated) {
                            ...
                            area = new chart._RectArea(new wijmo.Rect(Math.min(hi, lo), x - 0.5 * w, Math.abs(hi - lo), w));
                        } else {
    ...
    (function (chart) {
        ...
        var _VolumeHelper = (function () {
            ...
            _VolumeHelper.prototype.convert = function (x, min, max) {
                ...
                if (this._hasXs && this._xDataType === 4 /* Date */) {
                    // find directly
                    i = this._xVals.indexOf(x);

                    // remove time aspect and find directly
                    if (i === -1) {
                        i = this._xVals.indexOf(new Date(x).setHours(0, 0, 0, 0));
                    }
            ...
            _VolumeHelper.prototype.convertBack = function (x, min, max) {
                ...
                for (i = 0; i < len; i++) {
                    if ((this._calcData[i].x1 <= x && x <= this._calcData[i].x2) || (i === 0 && x <= this._calcData[i].x2) || (i === (len - 1) && this._calcData[i].x1 <= x)) {
                        idx = i;
                        break;
                    }
                }
            ...
            _VolumeHelper.prototype._fillGaps = function () {
                if (this._xDataType !== 4 /* Date */ || this._xVals === null || this._xVals.length <= 0) {
                    return;
                }
